...
//   // Загрузка данных
//   // Загрузка только данных календаря (без результатов)
//   useEffect(() => {
//     const fetchCalendarData = async () => {
//       try {
//         setLoading(true)
//         // Только минимальные данные для отображения календаря
//         await getTests() // Префетчим данные, но не сохраняем
//         setLoading(false)
//       } catch (error) {
...
//   // Ленивая загрузка результатов при открытии аккордеона
...
//       const localTests = await getTestsFromDB().catch(() => [])
//       const serverTests = await getTests()
//         .unwrap()
//         .catch(() => [])

//       const allEvents = [
//         ...processTestResults(localTests.length ? localTests : serverTests),
//         ...processInstructionsResults(instructionsResults || []),
//       ]
...
//     }
//   }, [getTests, instructionsResults, resultsLoaded])

//   const handleAccordionChange = async () => {
//     const newExpanded = !expanded
//     setExpanded(newExpanded)

//     if (newExpanded && !resultsLoaded) {
...
//           </Typography>
//           <Box display="flex" alignItems="center">
//             {resultsLoading && <CircularProgress size={20} sx={{ mr: 1 }} />}
//             <Typography variant="caption" color="text.secondary">
//               {expanded ? 'Скрыть' : 'Показать'}
//             </Typography>
//           </Box>
